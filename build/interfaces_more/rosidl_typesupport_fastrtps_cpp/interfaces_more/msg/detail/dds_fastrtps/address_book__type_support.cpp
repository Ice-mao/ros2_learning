...
#include "interfaces_more/msg/detail/address_book__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces_more::msg::AddressBook *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_more::msg::AddressBook *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_interfaces_more
const rosidl_message_type_support_t *
get_message_type_support_handle<interfaces_more::msg::AddressBook>()
{
  return &interfaces_more::msg::typesupport_fastrtps_cpp::_AddressBook__handle;
}
