...
interfaces_more__msg__AddressBook__init(interfaces_more__msg__AddressBook * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->first_name)) {
    interfaces_more__msg__AddressBook__fini(msg);
    return false;
  }
  // last_name
...
interfaces_more__msg__AddressBook__create()
{
  ...
  interfaces_more__msg__AddressBook * msg = (interfaces_more__msg__AddressBook *)allocator.allocate(sizeof(interfaces_more__msg__AddressBook), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces_more__msg__AddressBook));
  bool success = interfaces_more__msg__AddressBook__init(msg);
  if (!success) {
...
interfaces_more__msg__AddressBook__Sequence__init(interfaces_more__msg__AddressBook__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces_more__msg__AddressBook * data = NULL;

  if (size) {
    data = (interfaces_more__msg__AddressBook *)allocator.zero_allocate(size, sizeof(interfaces_more__msg__AddressBook), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces_more__msg__AddressBook__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces_more__msg__AddressBook__fini(&data[i - 1]);
      }
...
interfaces_more__msg__AddressBook__Sequence__fini(interfaces_more__msg__AddressBook__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces_more__msg__AddressBook__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces_more__msg__AddressBook__Sequence * array = (interfaces_more__msg__AddressBook__Sequence *)allocator.allocate(sizeof(interfaces_more__msg__AddressBook__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces_more__msg__AddressBook__Sequence__init(array, size);
  if (!success) {
...
interfaces_more__msg__AddressBook__Sequence__destroy(interfaces_more__msg__AddressBook__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces_more__msg__AddressBook__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces_more__msg__AddressBook__Sequence__are_equal(const interfaces_more__msg__AddressBook__Sequence * lhs, const interfaces_more__msg__AddressBook__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces_more__msg__AddressBook__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces_more__msg__AddressBook__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces_more__msg__AddressBook);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces_more__msg__AddressBook * data =
      (interfaces_more__msg__AddressBook *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces_more__msg__AddressBook__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces_more__msg__AddressBook__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces_more__msg__AddressBook__copy(
