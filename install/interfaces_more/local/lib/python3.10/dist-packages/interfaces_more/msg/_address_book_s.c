...
bool interfaces_more__msg__address_book__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_more.msg._address_book.AddressBook", full_classname_dest, 45) == 0);
  }
  interfaces_more__msg__AddressBook * ros_message = _ros_message;
  {  // first_name
...
PyObject * interfaces_more__msg__address_book__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_more.msg._address_book");
